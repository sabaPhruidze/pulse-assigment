...
const AssetRow = ({ asset, onClick }) => {
  return (
    ...
    >
      ...
      <td className="py-3 pr-4 font-semibold text-gray-900 dark:text-slate-100 whitespace-nowrap">
        {asset.symbol}
        <div className="sm:hidden text-xs text-gray-500 dark:text-slate-400 font-normal mt-1">
          {asset.name}
        </div>
      </td>

      {/* Name column - hidden on mobile */}
      <td className="py-3 pr-4 text-gray-700 dark:text-slate-200 min-w-[220px] hidden sm:table-cell">
        {asset.name}
      </td>

      {/* Price column - hidden on mobile */}
      <td className="py-3 pr-4 text-gray-900 dark:text-slate-100 whitespace-nowrap hidden sm:table-cell">
      ...
      <td className="py-3 text-gray-700 dark:text-slate-200 whitespace-nowrap hidden md:table-cell">
